...
class TransformerEncoderLayer(nn.Module):
    ...
    def _sa_block(self, x: Tensor, attn_mask: Optional[Tensor], key_padding_mask: Optional[Tensor], history_states: Optional[Tensor],
        ...
        #convert key_padding_mask to float
        key_padding_mask = key_padding_mask.to(torch.float32) if key_padding_mask is not None else None
        
        if key_padding_mask!=None: #CHANGED
